...
/**
 * Datas gravadas pelo SQLite com datetime('now') ficam em UTC
 * ("2026-09-22 22:00:17"). Sem o "Z", o navegador leria como horário
 * local e mostraria 3 horas a mais.
 */
export const dataDoBanco = (valor) => {
...
export const formatDataHoraBanco = (valor) => {
  const d = dataDoBanco(valor);
