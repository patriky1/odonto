                          ...
                          return (
                            ...
                            >
                              <p className="truncate" style={{ fontWeight: 700 }}>
                                {curto && <span style={{ fontWeight: 600 }}>{ag.horaInicio} </span>}<LinkPaciente id={ag.pacienteId} nome={ag.pacienteNome} />
                              </p>
                              {!curto && (
                                <>
                    ...
                    <tbody>
                      {listaDia.map(ag => (
                        <tr key={ag.id}>
                          ...
                          <td data-label="Paciente" style={{ fontWeight: 600 }}>
                            <div>
                              <LinkPaciente id={ag.pacienteId} nome={ag.pacienteNome} />
                              <RegistradoPor registro={ag} />
                            </div>
                          </td>
